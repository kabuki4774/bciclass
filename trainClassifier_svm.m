...
% Auto-generated by MATLAB on 11-Dec-2017 11:16:35
...
inputTable.observations_1 = inputTable.observations(:,1);
inputTable.observations_2 = inputTable.observations(:,2);

predictorNames = {'observations_1', 'observations_2'};
predictors = inputTable(:, predictorNames);
response = inputTable.stattes;
...
splitMatricesInTableFcn = @(t) [t(:,setdiff(t.Properties.VariableNames, {'observations'})), array2table(table2array(t(:,{'observations'})), 'VariableNames', {'observations_1', 'observations_2'})];
...
trainedClassifier.RequiredVariables = {'observations'};
